...
const styles = StyleSheet.create({
  ...
  invoiceTitle: { fontSize: 32, fontFamily: 'Helvetica-Bold', color: '#17613f', textAlign: 'right' },
  ...
  grandTotal: { flexDirection: 'row', justifyContent: 'flex-end', marginTop: 8, padding: 8, backgroundColor: '#17613f', borderRadius: 4 },
