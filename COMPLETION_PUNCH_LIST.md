...
| P1 | Monitoring | Add third-party error tracking after uptime baseline | Medium | High | Low | `/api/health`, UptimeRobot coverage, Vercel log runbook, and owner-approved error tracking are active. |
