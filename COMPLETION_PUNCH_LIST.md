...
| P1 | Unit tests | Expand Vitest coverage to API route wrappers and signed webhook fixtures | Medium | Medium | Low | More server behavior covered without depending on live Stripe or production Supabase. |
